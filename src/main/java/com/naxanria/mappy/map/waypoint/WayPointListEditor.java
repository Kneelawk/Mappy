...
public class WayPointListEditor extends ScreenBase
{
  ...
  public static final HashMap<String, BiValue<String, Identifier>> DIMENSION_INFO =
    new HashMap<String, BiValue<String, Identifier>>()
    {{
      put("minecraft:overworld",
        new BiValue<>("mappy.dim.overworld", new Identifier("textures/block/stone.png")));
      put("minecraft:the_nether",
        new BiValue<>("mappy.dim.nether", new Identifier("textures/block/nether_bricks.png")));
      put("minecraft:the_end",
        new BiValue<>("mappy.dim.the_end", new Identifier("textures/block/end_stone_bricks.png")));
    }};
...
//    private ButtonWidget chatButton;
    ...
    public Entry(WayPointListEditor wayPointListEditor, int x, int y, int width, int height, WayPoint wayPoint)
    {
      ...
      editButton = new ButtonWidget(0, 0, 40, height, wayPointListEditor.lang("edit"),
        (b) -> wayPointListEditor.edit(wayPoint));
      deleteButton = new ButtonWidget(0, 0, 40, height, wayPointListEditor.lang("delete"),
        (b) -> wayPointListEditor.delete(wayPoint));
...
//      chatButton.render(mouseX, mouseY, delta);
    ...
    {
      return editButton.mouseClicked(double_1, double_2, int_1) || deleteButton
        .mouseClicked(double_1, double_2, int_1);// || chatButton.mouseReleased(double_1, double_2, int_1);
    }

    @Override
    public boolean mouseReleased(double double_1, double double_2, int int_1)
    {
      return editButton.mouseReleased(double_1, double_2, int_1) || deleteButton
        .mouseReleased(double_1, double_2, int_1);// || chatButton.mouseReleased(double_1, double_2, int_1);
    }
  ...
  protected void init()
  {
    ...
    x = minecraft.getWindow().getScaledWidth() / 2 - width / 2;
    ...
    closeButton =
      new ButtonWidget(x + 15 + addButton.getWidth(), height - 25, 60, 20, lang("close"), (b) -> onClose());
...
//    System.out.println("RENDER");
    ...
    drawCenteredString(font, dimensionName, 130 / 2 + prevDimensionButton.x + prevDimensionButton.getWidth(), 15,
      0xffffffff);
